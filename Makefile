...
select: ## Select and run an example
	...
	@echo "1) chat basic"
	@echo "2) chat stream"
	@echo "3) chat concurrent"
	@echo "4) chat history"
	@echo "5) chat safety"
	@read -p "Choose an option: " choice; \
	case $$choice in \
		1) make execute example="01_chat.chat_basic" ;; \
		2) make execute example="01_chat.chat_stream" ;; \
		3) make execute example="01_chat.chat_concurrent" ;; \
		4) make execute example="01_chat.chat_history" ;; \
		5) make execute example="01_chat.chat_safety" ;; \
	esac
